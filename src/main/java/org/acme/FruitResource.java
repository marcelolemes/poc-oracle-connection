...
//        return Fruit.listAll(Sort.by("name")).await().atMost(Duration.ofMillis(100));
//    }
    @GET
...
//        if (fruit == null || fruit.id == 0) {
//            throw new WebApplicationException("Id was invalidly set on request.", 422);
//        }
//
//        return Panache.withTransaction(fruit::persist)
//                .replaceWith(Response.ok(fruit).status(CREATED)::build).await().atMost(Duration.ofMillis(300));
//    }
